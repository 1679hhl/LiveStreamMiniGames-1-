...
namespace ToJ
{
	...
	public class Mask : MonoBehaviour
	{
		...
		public Material SpritesAlphaMaskWorldCoords
		{
			get
			{
                if (this.spritesAlphaMaskWorldCoords != null)
                    GameObject.DestroyImmediate(this.spritesAlphaMaskWorldCoords);
                if (spritesAlphaMaskWorldCoords == null)
                {
                    this.spritesAlphaMaskWorldCoords = new Material(Shader.Find(MASKED_SPRITE_SHADER));
                    //spritesAlphaMaskWorldCoords = Resources.Load<Material>(SPRITES_RESOURCE_ADDRESS);
					if (spritesAlphaMaskWorldCoords == null)
					{
						Debug.LogError(MASKED_SPRITE_SHADER + " not found!");
					}
				}
		...
		private const string MASK_RESOURCE_ADDRESS = "Unlit/Transparent";
		public Material MaskMaterial
		{
			get
			{
				...
				{
					maskMaterial = new Material(Shader.Find(MASK_RESOURCE_ADDRESS));
                    if (maskMaterial == null)
					{
