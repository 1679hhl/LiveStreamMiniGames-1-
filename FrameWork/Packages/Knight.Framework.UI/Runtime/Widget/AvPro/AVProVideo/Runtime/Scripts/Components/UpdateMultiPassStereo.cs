...
namespace RenderHeads.Media.AVProVideo
{
	...
	public class UpdateMultiPassStereo : MonoBehaviour
	{
		...
		private void LogXRDeviceDetails()
		{
			...
			string logOutput = "[AVProVideo] XR Device details: UnityEngine.XR.XRSettings.loadedDeviceName = " + /*UnityEngine.XR.XRSettings.loadedDeviceName*/ "NONE XR" + " | supportedDevices = ";

            //string[] aSupportedDevices = UnityEngine.XR.XRSettings.supportedDevices;
            int supportedDeviceCount = 0; //aSupportedDevices.Length;
