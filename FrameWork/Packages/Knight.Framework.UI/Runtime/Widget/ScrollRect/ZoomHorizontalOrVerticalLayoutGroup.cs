...
namespace UnityEngine.UI
{
    ...
    ///
    [ExecuteAlways]
    public abstract class ZoomHorizontalOrVerticalLayoutGroup : LayoutGroup
    {
        ...
        protected virtual RectTransform GetChild(int index)
        {
            return rectChildren[index];
        }
        ...
        protected void CalcAlongAxis(int axis, bool isVertical)
        {
            ...
            if (!alongOtherAxis && GetChildCount() > 0)
            {
                totalMin -= spacing;
