        ...
        public class LetterSpacing : BaseMeshEffect
        {
            ...
            */
            ...
            public void ModifyVertices(List<UIVertex> verts)
            {
                ...
                if (text == null)
                {
                    Knight.Core.LogManager.LogWarning("LetterSpacing: Missing Text component");
                    return;
                }
                ...
                bool isRichText = true;//useRichText && text.supportRichText;
