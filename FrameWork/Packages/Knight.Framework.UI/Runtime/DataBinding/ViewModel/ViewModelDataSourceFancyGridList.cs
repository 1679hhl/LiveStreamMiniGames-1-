...
{
    public class ViewModelDataSourceFancyGridList : ViewModelDataSourceTemplate
    {
        public UnityEvent OnListChangedEvent = new UnityEvent();

        [DrawOrder(2)]
        public FancyBindingGridView ListView;
        ...
        public override void GetPaths()
        {
            ...
            this.ListView = this.GetComponent<FancyBindingGridView>();
