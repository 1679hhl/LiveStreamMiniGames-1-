...
{
    public class ViewModelDataSourceFancyList : ViewModelDataSourceTemplate
    {
        public UnityEvent OnListChangedEvent = new UnityEvent();

        [DrawOrder(2)]
        public FancyBindingScrollView ListView;
        ...
        public override void GetPaths()
        {
            ...
            this.ListView = this.GetComponent<FancyBindingScrollView>();
