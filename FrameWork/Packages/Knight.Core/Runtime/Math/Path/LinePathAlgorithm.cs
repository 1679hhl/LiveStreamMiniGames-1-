...
namespace Knight.Core.Math
{
    public class LinePathAlgorithm
    {
        ...
        public class LineBox
        {
            ...
            /// 竖直的平面
            /// </summary>
            public UnityEngine.Plane    VerticalPlane;
            ...
            private void CreateOBB(Line rLine)
            {
                ...
                this.OBB = new LineOBB(rCenter, rExtends, rXAxis, rYAxis, rZAxis);
                this.VerticalPlane = new UnityEngine.Plane(rZAxis, rCenter);
            }
