...
namespace Knight.Core
{
    public class TObjectPool<T> where T : new()
    {
        ...
        public T Alloc()
        {
            ...
            {
                this.AllocCount++;
                return UtilTool.SafeExecute(this.mActionAlloc);
            }
            else
            {
        ...
        {
            if (this.mStack.Count > 0 && object.ReferenceEquals(this.mStack.Peek(), rElement))
                return;
        ...
        public void Destroy()
        {
            ...
            {
                UtilTool.SafeExecute(this.mActionDestroy, rItem);
            }
            this.mStack.Clear();
            this.AllocCount = 0;
            this.FreeCount = 0;
        ...
        //public void Remove(T rElement)
        //{
        //    if (this.mActionDestroy != null)
        //        this.mActionDestroy(rElement);
        //    this.mStack.Remove(rElement);
        //}
