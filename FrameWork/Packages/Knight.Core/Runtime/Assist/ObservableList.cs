...
namespace Knight.Core
{
    ...
    public interface IObservableEvent
    {
        ...
        Action<object> ChangedHandler { get; set; }
        void Refresh();
    }

    public class ObservableList<T> : IList<T>, IList, IObservableEvent
    {
        private Action<object>              mChangedHandler     = null;
        ...
        public Action<object> ChangedHandler
        {
        ...
        public void Refresh()
        {
            UtilTool.SafeExecute(this.mChangedHandler, this);
        }
