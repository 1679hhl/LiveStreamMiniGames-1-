...
namespace Knight.Core
{
    ...
    public static class WaitAsync
    {
        ...
        public class WaitForUnscaleSecondsRequest : AsyncRequest<WaitForUnscaleSecondsRequest>
        {
            public float Time;

            public WaitForUnscaleSecondsRequest(float fTime)
            {
                this.Time = fTime;
            }
        }
        ...
        public static IAsyncOperation<WaitForUnscaleSecondsRequest> WaitForUnscaleSeconds(float fTime)
        {
            var rRequest = new WaitForUnscaleSecondsRequest(fTime);
            return rRequest.Start(WaitForUnscaleSeconds_Async(rRequest));
        }
        ...
        private static IEnumerator WaitForUnscaleSeconds_Async(WaitForUnscaleSecondsRequest rRequest)
        {
            yield return new WaitForSecondsRealtime(rRequest.Time);
            rRequest.SetResult(rRequest);
        }
