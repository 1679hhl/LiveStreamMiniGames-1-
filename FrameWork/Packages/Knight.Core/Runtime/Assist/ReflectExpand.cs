...
namespace Knight.Core
{
    public static class ReflectExpand
    {
        ...
        public static Object GetMemberValue(this Object @object, String memberName)
        {
            ...
            var fieldInfo = @object.GetType().GetField(memberName, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
            if (fieldInfo != null)
            {
                return fieldInfo.GetValue(@object);
            }
            var propertyInfo = @object.GetType().GetProperty(memberName, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
            if (propertyInfo != null)
            {
                return propertyInfo.GetValue(@object);
            }
            var methodInfo = @object.GetType().GetMethod(memberName, BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
            if (methodInfo != null)
            {
