...
namespace DG.Tweening.Core
{
    ...
    public static class Debugger
    {
        ...
        {
            Knight.Core.LogManager.Log("DOTWEEN :: " + message);
        }
        public static void LogWarning(object message)
        {
            Knight.Core.LogManager.LogWarning("DOTWEEN :: " + message);
        }
        public static void LogError(object message)
        {
            Knight.Core.LogManager.LogError("DOTWEEN :: " + message);
        }

        public static void LogReport(object message)
        {
            Knight.Core.LogManager.Log("<color=#00B500FF>DOTWEEN :: " + message + "</color>");
        }
