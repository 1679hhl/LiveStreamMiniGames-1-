...
public class AspectRatioController : MonoBehaviour
{
    ...
    // 长宽比的宽度和高度
    [SerializeField]
    private float aspectRatioWidth = 1080;
    [SerializeField]
    private float aspectRatioHeight = 1920;
    ...
    void Update()
    {
        ...
        {
            Debug.Log(
                $"setWidth:{setWidth} setHeight:{setHeight} Screen.width:{Screen.width} Screen.height:{Screen.height}");
